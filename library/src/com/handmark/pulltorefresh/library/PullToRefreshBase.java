...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP: {
                if (mIsBeingDragged) {
                    ...
                    if (isRefreshing()) {
                        smoothScrollTo(getTopScrollValue());
                        return true;
                    }
    ...
    protected int getTopScrollValue() {
        return 0;
    }
    ...
    public final void setRefreshing(boolean doScroll) {
        setRefreshing(doScroll, false);
    }

    public final void setRefreshing(boolean doScroll, boolean immediately) {
        if (!isRefreshing()) {
            setState(State.MANUAL_REFRESHING, doScroll, immediately);
        }
    }
    ...
    protected void onRefreshing(final boolean doScroll, final boolean immediately) {
